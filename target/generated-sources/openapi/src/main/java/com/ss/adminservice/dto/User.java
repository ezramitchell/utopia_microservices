...
public class User   {
   ...
   * @return id
  */
  @ApiModelProperty(value = "UUID string")
  ...
  */
  ...
  /**
   * This is available only for creating new accounts
   * @return password
  */
  @ApiModelProperty(value = "This is available only for creating new accounts")
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userRole, lastName, firstName, username, password, email, phone);
  }
